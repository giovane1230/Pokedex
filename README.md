...
- Use o comando: `git clone git@github.com:tryber/sd-031-b-exercise-pokedex-state`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-031-b-exercise-pokedex-state`
...
- Agora crie uma branch à qual você vai submeter os `commits` do seu exercício
  ...
  - Exemplo: `git checkout -b joaozinho-sd-031-b-exercise-pokedex-state`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-031-b-exercise-pokedex-state`

6. Crie um novo `Pull Request` _(PR)_

- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-031-b-exercise-pokedex-state/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-031-b-exercise-pokedex-state/pulls) e confira que o seu _Pull Request_ está criado
...
<details>
  ...
  [FORMULÁRIO DE AVALIAÇÃO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH31-B&template=betrybe/sd-0x-exercise-pokedex-state)
